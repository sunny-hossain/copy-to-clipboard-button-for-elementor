...
class Elementor_Clipboard_Button_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Clipboard Button', 'copy-to-clipboard-elementor' );
    }
    ...
    public function get_keywords(): array {
		return [ 'button', 'copy', 'clipboard', 'copy link', 'link copy'];
	}
    ...
    protected function register_controls(): void {
        ...
        */
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Content', 'copy-to-clipboard-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Text', 'copy-to-clipboard-elementor' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __( 'Click here', 'copy-to-clipboard-elementor' ),
                'dynamic' => [
                    'active' => true,
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Show clipboard text', 'copy-to-clipboard-elementor' ),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __( 'Show', 'copy-to-clipboard-elementor' ),
                'label_off' => __( 'Hide', 'copy-to-clipboard-elementor' ),
                'return_value' => 'yes',
                'default' => 'yes',
                'description' => esc_html__( 'Toggle to show or hide the clipboard text area.', 'copy-to-clipboard-elementor' ),
            ]
        );
        ...
        $this->add_control(
            'ctce_clipboard_text',
            [
                'label' => __( 'Clipboard Text', 'copy-to-clipboard-elementor' ),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => __( 'Your text here', 'copy-to-clipboard-elementor' ),
                'label_block' => true,
                'dynamic' => [
                    'active' => true,
                ],
                'description' => esc_html__( 'Enter the text or content you want users to copy when they click the button.', 'copy-to-clipboard-elementor' ),
        ...
        */
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Additional Content', 'copy-to-clipboard-elementor' ),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Text', 'copy-to-clipboard-elementor' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __( 'Copied!', 'copy-to-clipboard-elementor' ),
                'dynamic' => [
                    'active' => true,
                ],
                'description' => esc_html__( 'This text appears after successfully copying the link and temporarily changes the button text.', 'copy-to-clipboard-elementor' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Background color', 'copy-to-clipboard-elementor' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#008000',
                'description' => esc_html__( 'This color appears after successfully copying the link and temporarily changes the button background color. Default: #008000', 'copy-to-clipboard-elementor' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Time', 'copy-to-clipboard-elementor' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __( '3000', 'copy-to-clipboard-elementor' ),
                'description' => esc_html__( 'After a specified time, the button resets to its default text and color. Default delay: 3 seconds (1 second = 1000 milliseconds).', 'copy-to-clipboard-elementor' ),
            ]
        );
        ...
        */
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Box', 'copy-to-clipboard-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Padding', 'copy-to-clipboard-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Border Radius', 'copy-to-clipboard-elementor' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%' ],
                'selectors' => [
        ...
        */
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Text Color', 'copy-to-clipboard-elementor' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#000000',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Alignment', 'copy-to-clipboard-elementor' ),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => __( 'Left', 'copy-to-clipboard-elementor' ),
                        'icon' => 'eicon-text-align-left',
                    ],
                    'center' => [
                        'title' => __( 'Center', 'copy-to-clipboard-elementor' ),
                        'icon' => 'eicon-text-align-center',
                    ],
                    'right' => [
                        'title' => __( 'Right', 'copy-to-clipboard-elementor' ),
        ...
        */
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Button', 'copy-to-clipboard-elementor' ),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Position', 'copy-to-clipboard-elementor' ),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => __( 'Left', 'copy-to-clipboard-elementor' ),
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => __( 'Normal', 'copy-to-clipboard-elementor' ),
            ]
        );
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => __( 'Hover', 'copy-to-clipboard-elementor' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Border Color', 'copy-to-clipboard-elementor' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function render(): void {
        ...
        <div id="<?php echo esc_attr( $widget_id ); ?>" class="ctce-clipboard-content" 
            ...
            data-clipboard-text = "<?php echo esc_attr( $settings['ctce_clipboard_text'] ); ?>"
            >
            
            <?php if ( ! empty( $settings['ctce_clipboard_show_text'] ) ) : ?>
            <div class="ctce-clipboard-text-wrap">
                <h4><?php echo esc_html( $settings['ctce_clipboard_text'] ); ?></h4>
            </div>
            <?php endif; ?>
    ...
    protected function content_template(): void {
        ...
        <div id="{{{ widgetId }}}" class="ctce-clipboard-content" 
            ...
            data-clipboard-text = "{{{ settings.ctce_clipboard_text }}}"
        >
