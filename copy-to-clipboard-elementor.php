 ...
 * Plugin URI:  https://wordpress.org/plugins/copy-to-clipboard-button-for-elementor/
 * Author:      Sunny Hossain
 * Author URI:  https://profiles.wordpress.org/sunnyhossain/
 * Description: Elementor widget to add a copy to clipboard button.
 * Version:     1.0.0
 * License:     GPL-2.0+
 * License URI: http://www.gnu.org/licenses/gpl-2.0.txt
 * Text Domain: copy-to-clipboard-elementor
...
function ctce_enqueue_clipboard_assets() {
    wp_enqueue_script( 
        'ctce-clipboard',
        plugins_url( 'includes/clipboard.js', __FILE__ ),
        [ 'jquery' ],
        '1.0.0',
        true
    );
    wp_enqueue_style(
        'ctce-clipboard',
        plugins_url( 'includes/clipboard.css', __FILE__ ),
        [],
        '1.0.0'
    );
}
